 ...
 *
 *  file:  include\PositionControllerPan\xxsim\PositionControllerPanModel.hpp
...
/* This file describes the model functions
 ...
 The model itself is the PositionControllerPanModel.cpp file
 */
...
namespace PositionControllerPan
{
  ...
  class PositionControllerPanModel: virtual Submodel20sim
  {
    public:

    /**
     * PositionControllerPanModel constructor
     */
    PositionControllerPanModel();

    /**
     * PositionControllerPanModel destructor
     */
    virtual ~PositionControllerPanModel(void);
