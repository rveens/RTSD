    ...
    Recursion<CSProcess>()
{
  ...
  AnyIO::AnyioEncoderSettings myencoderport_to_EncoderTesterinChannelSettings;
  ...
  myencoderport_to_EncoderTesterinChannel = new AnyIO::AnyioEncoderLinkDriver<uint32_t>(myencoderport_to_EncoderTesterinChannelSettings);
