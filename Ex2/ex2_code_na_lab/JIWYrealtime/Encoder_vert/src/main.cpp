...
// protected region RTlogger support end  
  ...
  LOGLOCAL(LOG_INFO, "Setting up a signal handler, press ctrl+c to stop Encoder_vert.\n");
  ...
  LOGLOCAL(LOG_INFO, "Constructing the Encoder_vert structure:\n");
...
// protected region manual tree modifications end  
  ...
  LOGLOCAL(LOG_INFO, "Starting Encoder_vert - term thread: %p\n", term->getIThread());
  term->activate();
...
// protected region additional code end
  ...
  LOGLOCAL(LOG_INFO, "Encoder_vert stopped.\n");
