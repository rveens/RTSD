...
// protected region RTlogger support end  
  ...
  LOGLOCAL(LOG_INFO, "Setting up a signal handler, press ctrl+c to stop PWMtester.\n");
  ...
  LOGLOCAL(LOG_INFO, "Constructing the PWMtester structure:\n");
...
// protected region manual tree modifications end  
  ...
  LOGLOCAL(LOG_INFO, "Starting PWMtester - term thread: %p\n", term->getIThread());
  term->activate();
...
// protected region additional code end
  ...
  LOGLOCAL(LOG_INFO, "PWMtester stopped.\n");
