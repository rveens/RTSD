 ...
 *
 *  file:  src\xxsim\PositionControllerPanModel.cpp
 *  subm:  PositionControllerPanModel
...
namespace PositionControllerPan
{
  ...
  PositionControllerPanModel::PositionControllerPanModel()
  {
    setupComputation();
  }

  PositionControllerPanModel::~PositionControllerPanModel(void)
  {
    /* delete IO mappings */
  ...
  void PositionControllerPanModel::setupComputation()
  {
    start_time = 0.0;
    finish_time = 0;
    step_size = 0.01;
  ...
  bool PositionControllerPanModel::initializeComputation()
  {
  ...
  void PositionControllerPanModel::CopyInputsToVariables()
  {
  ...
  void PositionControllerPanModel::CopyVariablesToOutputs()
  {
  ...
  void PositionControllerPanModel::start()
  {
  ...
  void PositionControllerPanModel::step()
  {
  ...
  void PositionControllerPanModel::stop()
  {
    CopyInputsToVariables();
   ...
   */
  inline void PositionControllerPanModel::CalculateInitial (void)
  {
   ...
   */
  inline void PositionControllerPanModel::CalculateStatic (void)
  {
   ...
   */
  inline void PositionControllerPanModel::CalculateInput (void)
  {
   ...
   */
  inline void PositionControllerPanModel::CalculateDynamic (void)
  {
    	/* PID1\factor = 1 / (sampletime + PID1\tauD * PID1\beta); */
	V[2] = 1.0 / (step_size + P[2] * P[3]);
	...
	R[0] = V[2] * (((P[2] * s[0]) * P[3] + (P[2] * P[1]) * (R[1] - s[1])) + (step_size * P[1]) * R[1]);
   ...
   */
  inline void PositionControllerPanModel::CalculateOutput (void)
  {
   ...
   * are performed
   */
  inline void PositionControllerPanModel::CalculateFinal (void)
  {
