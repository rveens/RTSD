...
#if LUNA_REVISION < 1633
#  warning "LUNA is (too) old, please update to last known version: 1633"
#endif
...
// protected region RTlogger support end  
  ...
  LOGLOCAL(LOG_INFO, "Setting up a signal handler, press ctrl+c to stop prod_cons_DF.\n");
  ...
  LOGLOCAL(LOG_INFO, "Constructing the prod_cons_DF structure:\n");
...
// protected region manual tree modifications end  
  ...
  LOGLOCAL(LOG_INFO, "Starting prod_cons_DF - term thread: %p\n", term->getIThread());
  term->activate();
...
// protected region additional code end
  ...
  LOGLOCAL(LOG_INFO, "prod_cons_DF stopped.\n");
