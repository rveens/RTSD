...
private:
  ...
  // Channel definitions
  UnbufferedChannel<int, One2In, Out2One> *myProducer12prod_ch1_to_Consumer12cons_ch1Channel;
  UnbufferedChannel<int, One2In, Out2One> *myProducer12prod_ch2_to_Consumer12cons_ch2Channel;
